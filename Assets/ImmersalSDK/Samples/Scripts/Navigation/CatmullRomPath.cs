...
namespace Immersal.Samples.Navigation {
    public class CatmullRomPath : MonoBehaviour {
        ...
        [SerializeField]
        private float m_ResampledStepSize = 0.5f;
        [SerializeField]
        ...
        private float m_minStepSize = 0.2f;

        [SerializeField]
        private float m_PathWidth = 0.7f;
        ...
        private void GenerateMesh(List<Vector3> points, Vector3 up)
        {
            ...
            for (int i = 0; i < points.Count; i++)
            {
                ...
                {
                    int id = offset + j;
                    vertices[id] = matrices[i].MultiplyPoint(shape[j] * m_PathWidth);
        ...
        {
            GeneratePath(points, new Vector3(0f, 1f, 0f));
        }
